...
The package is early: it installs and imports closed graph types, a swappable embedder, a SurrealDB store, first-party extract and resolve agents, and a last-N episode context window.
